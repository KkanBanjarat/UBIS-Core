        ...
        <div class="flex items-center gap-3">
          ...
          <div>
            <h3 class="font-semibold text-base leading-tight">
              {{ isCreate ? 'เพิ่มสวัสดิการ' : 'แก้ไขสวัสดิการ' }}
            </h3>
        ...
        <div class="overflow-y-auto px-6 py-5 space-y-4 flex-1">
          <div>
            <label class="block text-xs font-medium text-base-content/60 mb-1.5">
              ชื่อสวัสดิการ (ไทย) <span class="text-error">*</span>
            </label>
            <input
          ...
          <div>
            <label class="block text-xs font-medium text-base-content/60 mb-1.5">
              ชื่อสวัสดิการ (อังกฤษ) <span class="text-error">*</span>
            </label>
            <input
...
const defaultForm = { nameTh: '', nameEn: '', isActive: true }
...
function open(item?: Benefit | null) {
  errors.value = {}
  formData.value = item
    ? { nameTh: item.nameTh, nameEn: item.nameEn, isActive: item.isActive }
    : { ...defaultForm }
