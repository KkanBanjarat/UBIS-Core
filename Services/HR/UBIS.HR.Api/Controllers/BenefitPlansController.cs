...
public class BenefitPlansController : ControllerBase
{
    ...
    public BenefitPlansController(IBenefitPlanService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Create(CreateBenefitPlanDto data)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> UpdateAsync(Guid id, CreateBenefitPlanDto data)
    {
