...
public class BenefitPlanItemsController : ControllerBase
{
    private readonly IBenefitPlanItemService _service;
    

    public BenefitPlanItemsController(IBenefitPlanItemService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Create(CreateBenefitPlanItemDto data)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> UpdateAsync(Guid id, CreateBenefitPlanItemDto data)
    {
